...
function buscarAll($conexao, $tabela, $order = "", $where = 1) { //Como os valores de order e where ja estão definidos, caso não queira ordenar ou filtrar com where deixe em branco
