...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO pessoafisica (nome, sobrenome, data_nasc, sexo, email, cpf, celular, telefone, cep, senha) VALUES (':nome',':sobrenome',':data_nasc',':sexo',':email',':cpf',':celular',':telefone',':cep',':senha')";
