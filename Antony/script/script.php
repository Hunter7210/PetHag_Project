<script>// Dados de exemplo para produtos
const produtos = [  </script> <?php 


    
//Criar uma função para buscar la no banco de dados e exibir as imagens e a descrição aqui
